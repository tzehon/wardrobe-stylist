...
Phases 0, 1, 2a–2e, 3, 4, and 5 are done. Phase 5 shipped as a single Opus 4.8 `/recommend` call (no weather, no subagents in v1); Phase 6 (background sync, notifications, TestFlight) is next.
