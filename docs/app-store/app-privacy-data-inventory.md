...
| Outfit and wear history | Anti-repeat/history | Recent item IDs leave for styling | Backend → Anthropic recommendation | Request only; local history until delete | Styling consent; delete | Pending retention interpretation |
